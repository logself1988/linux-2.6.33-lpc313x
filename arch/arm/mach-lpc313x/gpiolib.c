...
static int lpc313x_gpiolib_direction_input(struct gpio_chip *chip, unsigned offset);
static int lpc313x_gpiolib_direction_output(struct gpio_chip *chip, unsigned offset, int val);
static int lpc313x_gpiolib_get(struct gpio_chip *chip, unsigned offset);
static void lpc313x_gpiolib_set(struct gpio_chip *chip, unsigned offset, int val);
